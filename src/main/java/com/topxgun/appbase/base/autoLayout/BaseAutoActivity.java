...
public class BaseAutoActivity extends AutoLayoutActivity implements OnClickListener {
    ...
    public static class MyHandler extends Handler {
        private final WeakReference<BaseAutoActivity> mActivity;

        public MyHandler(BaseAutoActivity activity) {

            mActivity = new WeakReference<BaseAutoActivity>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            BaseAutoActivity baseActivity = mActivity.get();
